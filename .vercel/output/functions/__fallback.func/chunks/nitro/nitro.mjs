...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "cdede2f2-35c5-4049-ad1e-12948d0a1edc",
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/giorgiomessore/Desktop/sito-portfolio-nuxt/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const checksums = {
  "projects": "v3.5.0--GzPe24TdzkUBurGsE3woCWO9g19xy8rT8rYENTlELZ0",
  "home": "v3.5.0--_grYGOEFbqDuXQMeJQdY4QGia5VFPp6oYNIuqSjK9yU"
};
...
const _Aana0l = defineCachedEventHandler(async (event) => {
...
const _cUhBxb = eventHandler(async (event) => {
...
const _MprqR2 = eventHandler(async (event) => {
...
const _lazy_vksCmC = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_vksCmC, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _Aana0l, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _cUhBxb, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _MprqR2, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_vksCmC, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, createRouter$1 as A, defu as B, pascalCase as C, kebabCase as D, withLeadingSlash as E, parseURL as F, stringifyQuery as G, listener as H, getResponseStatus as a, buildAssetsURL as b, getQuery as c, defineRenderHandler as d, createError$1 as e, destr as f, getResponseStatusText as g, getRouteRules as h, useNitroApp as i, parseQuery as j, klona as k, defuFn as l, hasProtocol as m, joinURL as n, getContext as o, publicAssetsURL as p, withTrailingSlash as q, withoutTrailingSlash as r, isScriptProtocol as s, sanitizeStatusCode as t, useRuntimeConfig as u, baseURL as v, withQuery as w, createHooks as x, executeAsync as y, toRouteMatcher as z };
