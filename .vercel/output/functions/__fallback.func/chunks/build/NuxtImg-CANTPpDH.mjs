...
import { B as defu, E as withLeadingSlash, m as hasProtocol, n as joinURL, F as parseURL, G as stringifyQuery } from '../nitro/nitro.mjs';
import { b as useNuxtApp, u as useRuntimeConfig } from './server.mjs';
import { a as useHead } from './composables-3F9Qpb2F.mjs';
...
const getImage = (src, { modifiers, baseURL = "/_vercel/image" } = {}, ctx) => {
...
const vercelRuntime$P_45WG4RzaDZNbTpQZjU9moOQ0Wjw2LOToxVRzBy7alSg = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage,
  validateDomains
...
const imageOptions = {
  ...
  providers: {
    ["vercel"]: { provider: vercelRuntime$P_45WG4RzaDZNbTpQZjU9moOQ0Wjw2LOToxVRzBy7alSg, defaults: {} }
  }
};
...
//# sourceMappingURL=NuxtImg-CANTPpDH.mjs.map
